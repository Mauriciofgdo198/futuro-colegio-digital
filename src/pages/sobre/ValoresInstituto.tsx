      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p>O Instituto Novos Tempos tem como proposta pedagógica a EDUCAÇÃO LIBERTADORA – uma educação contextualizada e problematizadora.

          </p>
            
            <p>Propõe desenvolver, em seus alunos, a afetividade, a inteligência, conhecimentos, as dimensões comunitária e social.

          </p>
            
            <p>Há um esforço para tornar realidade uma pedagogia que: Educa através da presença, da simplicidade, do espírito de família, do amor ao trabalho e de uma profunda relação com Deus;
